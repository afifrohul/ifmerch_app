    ...
    <div class="jumbotron pb-5">
      <div class="row mt-5 pb-5">
        <div class="col-lg-6" data-aos="fade-right">
          <h1 class="display-1">IF MERCH</h1>
          <p class="fs-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi, esse nostrum doloribus deserunt eveniet animi quae qui cum possimus illo dolores vero id quod officia ut repellendus inventore aut harum.</p>
          <hr class="my-4">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis numquam repellendus eligendi nisi! Repudiandae inventore quaerat hic?</p>
          <a class="btn btn-danger btn-lg" href="#" role="button">ORDER NOW!</a>
        </div>
        <div class="col-lg-6" data-aos="fade-up">
          {{-- <img src="/img/merch2.jpg" alt="merch" class="img-fluid rounded"> --}}
          <svg width="100%" height="100%" viewBox="0 0 880 632" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0_12_2)">
          <path d="M645 0.365021H0.275024V413.275H645V0.365021Z" fill="#E6E6E6"/>
          <path d="M626.564 52.154H18.7111V388.847H626.564V52.154Z" fill="white"/>
          <path d="M644.725 0H0V27.39H644.725V0Z" fill="#DC3545"/>
          <path d="M20.355 19.081C23.1589 19.081 25.432 16.808 25.432 14.004C25.432 11.2001 23.1589 8.927 20.355 8.927C17.551 8.927 15.278 11.2001 15.278 14.004C15.278 16.808 17.551 19.081 20.355 19.081Z" fill="white"/>
          <path d="M39.624 19.081C42.4279 19.081 44.701 16.808 44.701 14.004C44.701 11.2001 42.4279 8.927 39.624 8.927C36.82 8.927 34.547 11.2001 34.547 14.004C34.547 16.808 36.82 19.081 39.624 19.081Z" fill="white"/>
          <path d="M58.893 19.081C61.697 19.081 63.97 16.808 63.97 14.004C63.97 11.2001 61.697 8.927 58.893 8.927C56.0891 8.927 53.816 11.2001 53.816 14.004C53.816 16.808 56.0891 19.081 58.893 19.081Z" fill="white"/>
          ...
          <path d="M402.096 547.809L401.46 549.286L422.757 558.455L423.392 556.979L402.096 547.809Z" fill="#DC3545"/>
          <path d="M479.563 509.397L481.463 599.638L539.882 630.51L646.271 611.512L648.883 517.709L581.44 493.961L479.563 509.397Z" fill="#DC3545"/>
          ...
          <path d="M796.45 295.851L803.871 285.478C803.871 285.478 808.95 284.351 814.95 291.351C820.95 298.351 824.45 385.851 824.45 385.851L802.45 390.851L789.45 328.851L796.45 295.851Z" fill="#DC3545"/>
          <path d="M756.133 289.743L747.95 284.351C747.95 284.351 741.635 285.767 734.919 298.685C728.203 311.603 701.119 369.357 701.119 369.357L712.252 380.657L741.952 335.348L756.133 289.743Z" fill="#DC3545"/>
          <path d="M747.466 284.977L803.866 285.434L791.95 406.351C791.95 406.351 725.991 402.87 725.95 382.737L732.129 364.846L747.466 284.977Z" fill="#DC3545"/>
          ...
          <path d="M682.096 439.809L681.46 441.286L702.757 450.455L703.392 448.979L682.096 439.809Z" fill="#DC3545"/>
...
<section class="bg-light p-5" id="about">
  <div class="container space" data-aos="fade-up">
    <div class="row text-center">
      <h1>ABOUT</h1>
    </div>
    <div class="row text-center justify-content-center">
      <div class="col-lg-8 pt-5">
        <p class="fs-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus incidunt corrupti vitae. Dignissimos beatae inventore dolore excepturi, explicabo iure quis enim harum nostrum aliquam nemo labore nesciunt assumenda repudiandae nam.</p>
      </div>
    </div>
    <div class="row text-center justify-content-center mt-5">
      <div class="col-lg-4">
        ...
        <hr>
        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsa ea quos nostrum delectus, voluptatum totam eligendi maxime aliquid quae nisi!</p>
      </div>
      <div class="col-lg-4">
...
<section class="p-5 bg-dark text-white" id="product">
    ...
    <div class="row justify-content-center" data-aos="fade-up">
      ...
      <div class="col-lg-3 m-3"> 
        <div class="card">
          ...
          @else    
          <img src="/storage/{{ $product->image }}" class="img-fluid d-block"" >
          @endif
          <hr>
          <div class="card-body text-center text-black">
            <h5 class="card-title">{{ $product->name }}</h5>
            <p class="card-text">{!! $product->desc !!}</p>
            <a href="/product/{{ $product->slug }}" class="btn btn-danger">ORDER NOW!</a>
          </div>
        </div>
      </div>
      @endforeach
    </div>
    <div class="row text-end mt-5" data-aos="fade-right">
      <a href="/product" class="text-danger text-decoration-none"><h4>See More <i class="bi bi-arrow-right"></i></h4></a>
    </div>
  </div>
</section>

<section class="p-5" id="feedback" data-aos="fade-up" data-aos-offset="500">
  <div class="container space space2">
    ...
    <div class="row justify-content-start mt-5">
      ...
      <div class="col-lg-2 border-end p-3 mt-3">
        {{-- <img src="/img/{{ $testi->image }}" alt="{{ $testi->image }}" class="img-fluid rounded-circle"> --}}
        @if ($testi->image == 'testi.jpg')
          <img src="https://source.unsplash.com/400x400?profile" alt="img" class="img-fluid" style="clip-path:circle()">
        @else    
          <img src="/storage/{{ $testi->image }}" class="img-fluid mb-3 d-block" style="clip-path:circle()" >
        @endif
      </div>
...
<section class="p-5 bg-danger text-white" id="faq" data-aos="fade-up">
  <div class="container space space2">
    <div class="row text-center">
      <h1>FAQ</h1>
    </div>
    <div class="row mt-4 justify-content-center">
      {{-- awal php --}}
      {{-- setiap 1 di ganti id --}}
      @foreach ($question as $faq) 
      <div class="col-lg-4 text-black m-3">
